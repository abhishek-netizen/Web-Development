...
class Count extends React.Component {
  ...
  return (
    <div id="count">
      ...
      <ShowCount count = {this.state.count} msg = "hellof" />
      <CountForm increaseCount = {this.increase} decreaseCount = {this.decrease} resetCount ={this.reset} />
    </div>
  )
}
}

export default Count;f